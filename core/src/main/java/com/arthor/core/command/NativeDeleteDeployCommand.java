...
public class NativeDeleteDeployCommand extends AbstractDeleteDeployCommand {
    ...
    protected CreateDeploymentRequest buildDeleteDeploymentRequest(CommandContext commandContext,
        ...
        deleteDeploymentRequest.setServiceStatus(deployment.getExternal() ? PROCESSING : null);
